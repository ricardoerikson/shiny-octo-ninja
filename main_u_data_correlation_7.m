...
% Configuração: 90% treinamento e 10% teste
...
save(['dataset/u_data_t90_p10.mat'],'non_observed_set','training_correlation','training_ratings','probe_set','training_set','ratings_matrix','-mat');